import { ValidationResult } from '@/lib/onboardingValidation';

type Props = { validationResult: ValidationResult };

export function ValidationSummary({ validationResult }: Props) {
